...
public class AssetZombie {
    private static final String TAG = AssetZombie.class.getName();
    ...
    public AssetZombie(TextureAtlas atlas) {
        layer1 = atlas.findRegion("zombie1");
        layer2 = atlas.findRegion("zombie2");
        layer3 = atlas.findRegion("zombie3");
        layer4 = atlas.findRegion("zombie4");
        layer5 = atlas.findRegion("zombie5");
        layer6 = atlas.findRegion("zombie6");
        layer7 = atlas.findRegion("zombie7");
    }
    ...
    public void build(ParallaxSB parallaxSB) {
        ...
        parallaxSB.addDynamicLayer(layer6, 2, true, LAYER6_VEL); // clouds
